...
function initSearch() {
  ...
  request.open('GET', '/New_BAI_DataAnalysis/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/New_BAI_DataAnalysis/assets/css/just-the-docs-' + theme + '.css');
}
